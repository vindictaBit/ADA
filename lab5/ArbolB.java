...
public class ArbolB<E extends Comparable<? super E>> implements InterfaceB<E> {
    ...
    public E remove(E value) {
    	root = null; //ubica, remueve, reordena
        return null;
    }
    ...
    private static class Node<T extends Comparable<T>> {
        ...
        private T removeKey(int index) {
            ...
            for (int i = index + 1; i < keysSize; i++) {
                keys[i - 1] = keys[i];		// desplazar el resto hacia abajo
            }
            keysSize--;
            keys[keysSize] = null;
            return value;
        ...
        private Node<T> removeChild(int index) {
            ...
            for (int i = index + 1; i < childrenSize; i++) {
                children[i - 1] = children[i];		// desplazar el resto hacia abajo
            }
            childrenSize--;
            children[childrenSize] = null;
            return value;
