...
class BiGraf {
    public boolean Comprobar(int[][] grafo) {
        ...
        for(int inicio = 0; inicio < n; inicio++){
            Stack<Integer> pila = new Stack<>();  // Usamos la pila para el recorrido del grafo
            pila.push(inicio);
            color[inicio] = 0; 					
            ...
            while (!pila.isEmpty()){
                ...
                if (color[vertice] == -1){
                	...
                	// significa que no es posible colorear y el grafo no es un grafo bipartito.
                	
                	// Para esto recorremos el grafo
